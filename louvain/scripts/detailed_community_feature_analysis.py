...
within each community detected by Louvain algorithm. For every community and 
every feature, this shows what percentage of games in that community have each 
possible value.

Usage:
    python detailed_community_feature_analysis.py --communities /path/to/community_assignments.csv --metadata /path/to/dead_labels_enriched.csv --out-dir ./detailed_analysis/
"""
