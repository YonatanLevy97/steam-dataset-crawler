...
Example script showing how to analyze Girvan-Newman community detection results
by joining with Steam game metadata to understand what the communities represent.

Usage:
    python analyze_community_results.py --communities /path/to/community_assignments_best.csv --metadata /path/to/dead_labels_enriched.csv --out-dir ./community_analysis/
"""
